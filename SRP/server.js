...
app.post('/api/login', function(req, res) {
    ...
    if (username == "selim")
        server.init({ salt: Csal, verifier: Cverif }, function(){
            // THe server sends back the corresponding salt to the client
